...
@section('content')
    ...
    <header id="fh5co-header" class="fh5co-cover" style="background-image:url(template/assets/images/bg_1.jpeg); background-position: center bottom !important; background-attachment: fixed !important;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-push-5 animate-box">
                        <img class="img-responsive" src="template/assets/images/work_1.png" alt="work">
                    </div>
        ...
        <div class="container-fluid proj-bottom">
            <div class="row">
                <div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
                    <a href="#"><img src="template/assets/images/project-1.jpg" alt="Free HTML5 Website Template by FreeHTML5.co"
                ...
                <div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
                    <a href="#"><img src="template/assets/images/project-2.jpg" alt="Free HTML5 Website Template by FreeHTML5.co"
                                     class="img-responsive">
                ...
                <div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
                    <a href="#"><img src="template/assets/images/project-3.jpg" alt="Free HTML5 Website Template by FreeHTML5.co"
                                     class="img-responsive">
                        <h3>Read Bible</h3>
                        <span>View Course</span>
                    </a>
                ...
                <div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
                    <a href="#"><img src="template/assets/images/project-9.jpg" alt="Free HTML5 Website Template by FreeHTML5.co"
                                     class="img-responsive">
                        <h3>Programming</h3>
                        <span>View Course</span>
                    </a>
                ...
                <div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
                    <a href="#"><img src="template/assets/images/project-5.jpg" alt="Free HTML5 Website Template by FreeHTML5.co"
                                     class="img-responsive">
                        <h3>Technician</h3>
                        <span>View Course</span>
                    </a>
                ...
                <div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
                    <a href="#"><img src="template/assets/images/project-6.jpg" alt="Free HTML5 Website Template by FreeHTML5.co"
                                     class="img-responsive">
                        <h3>Photography</h3>
                        <span>View Course</span>
                    </a>
    ...
    @include('template.includes.testimonials')
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="fh5co-blog animate-box">
                        ...
                        <div class="blog-text">
                            <h3><a href="{{ route('article', $post->uri) }}">{{ str_limit($post->title, 80) }}</a></h3>
                            <span class="posted_on">{{ date('d/m/Y H:i', strtotime($post->created_at)) }}</span>
                            <span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
                            <p>{{ str_limit($post->subtitle, 80) }}</p>
    ...
    @include('template.includes.optin')
